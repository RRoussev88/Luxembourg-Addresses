...
CREATE TABLE IF NOT EXISTS "localities_to_postal_codes" (
	"locality_id" integer NOT NULL,
	"postal_code_id" integer NOT NULL,
	CONSTRAINT "composite_key" PRIMARY KEY("locality_id","postal_code_id")
);
--> statement-breakpoint
...
DO $$ BEGIN
 ALTER TABLE "localities_to_postal_codes" ADD CONSTRAINT "localities_to_postal_codes_locality_id_luxembourg_localities_id_fk" FOREIGN KEY ("locality_id") REFERENCES "luxembourg_localities"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "localities_to_postal_codes" ADD CONSTRAINT "localities_to_postal_codes_postal_code_id_luxembourg_postal_codes_id_fk" FOREIGN KEY ("postal_code_id") REFERENCES "luxembourg_postal_codes"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
